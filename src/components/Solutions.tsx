...
import { Database, Brain, Network, FileBarChart, Bot, Zap, Shield, Cloud, Lock, Target, Lightbulb, Users2 } from "lucide-react";
...
const solutions = [
  ...
  },
  {
    ...
    details: "Servercrib Labs is our dedicated innovation and research & development division focused on emerging technologies. We help organizations explore, prototype, and implement cutting-edge solutions in AI, blockchain, IoT, quantum computing, and other transformative technologies. Our R&D services include technology feasibility studies, proof-of-concept development, pilot program design and execution, emerging tech assessment, innovation workshops, research partnerships with academic institutions, patent and IP strategy, technology incubation programs, venture lab services, and strategic innovation roadmaps. Partner with us to turn tomorrow's technologies into today's competitive advantages.",
  },
  {
    icon: Users2,
    title: "Servercrib Partner Network",
    description: "Collaboration hub for resellers and system integrators.",
    details: "The Servercrib Partner Network is a comprehensive collaboration hub connecting resellers, system integrators, technology partners, and consultants in a thriving ecosystem. Join our network to access exclusive benefits including partner enablement programs, co-marketing opportunities, deal registration and lead sharing, technical training and certifications, partner portal with sales resources, competitive pricing and margins, joint go-to-market strategies, technical pre-sales support, solution architect assistance, partner incentive programs, early access to new products, and dedicated partner success managers. Grow your business with Servercrib as your strategic technology partner.",
  },
];
          ...
          <div className="max-w-5xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8 animate-fade-in">
              <Button 
                ...
                onClick={() => document.getElementById('solutions-grid')?.scrollIntoView({ behavior: 'auto' })}
              >
