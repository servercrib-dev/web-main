...
const productCategories: ProductCategory[] = [
  {
    ...
    subtitle:
      "Foundation Layer - The core layer that powers every Servercrib solution — connecting automation, AI, and cloud infrastructure.",
    products: [
      {
        icon: Cpu,
        title: "AvenCore",
      ...
      },
      {
        ...
        description:
          "Developer and designer studio that enables 'prompt-to-app' creation and live code export.",
        details:
          "AvenForge is an innovative developer and designer studio that revolutionizes application development with prompt-to-app capabilities. Describe your application in natural language, watch it come to life, and export production-ready code instantly. The studio provides: AI-powered Prompt-to-App Generation, Visual Design Editor & Customization, Real-time Code Preview, Live Code Export (React, Vue, Angular, etc.), Component Library & Templates, Responsive Design Tools, Database Schema Designer, API Endpoint Generator, Authentication & Authorization Setup, Testing & Debugging Tools, Version Control Integration, Collaboration Features for Teams, Cloud Deployment Options, and Integration with AvenERP & AvenCore. Build applications faster than ever with AvenForge.",
      },
      {
        icon: Cloud,
        title: "AvenCloud",
  ...
  },
  {
    ...
    subtitle:
      "Business Layer - Scalable, industry-focused solutions that drive digital transformation across all sectors.",
    products: [
      {
        icon: Database,
  ...
  },
  {
    ...
    subtitle:
      "Protecting the digital enterprise through advanced AI-driven cybersecurity.",
    products: [
      {
        icon: Shield,
      ...
      },
      {
        ...
        description:
          "Threat and vulnerability detection system for applications, APIs, and networks.",
        details:
  ...
  },
  {
    ...
    subtitle:
      "Empowering individuals, teams, and innovators through education and collaboration.",
    products: [
      {
        icon: Briefcase,
          ...
          <div className="mt-20 text-center">
            <div className="mb-12 p-12 bg-gradient-to-br from-card/80 via-card/50 to-card/80 backdrop-blur-sm border border-border/50 rounded-2xl max-w-4xl mx-auto">
              ...
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                Whether you're scaling a startup or modernizing a global
                enterprise, Servercrib's suite of products delivers the
                intelligence, automation, and security your business deserves.
              </p>
