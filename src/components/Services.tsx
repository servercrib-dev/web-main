...
const services = [
  {
    ...
    description:
      "Round-the-clock system monitoring, incident response, and technical troubleshooting.",
    details:
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-4xl mx-auto mb-8 leading-relaxed animate-fade-in">
              We deliver continuous IT excellence through ERP/CRM customization,
              cybersecurity operations, cloud management, and 24/7 support
              services — so your business stays secure, efficient, and
              future-ready.
            </p>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-4xl mx-auto">
              Servercrib Technology Solutions provides ongoing managed services,
              software development, and technical support to keep your digital
              ecosystem secure, scalable, and future-ready.
            </p>
          </div>
