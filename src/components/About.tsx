...
import toluImage from "@/assets/tolu.jpg";
            ...
            <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
              <Card className="border-border/50 bg-card/50 backdrop-blur-sm hover:border-primary/50 transition-all duration-300">
                <CardContent className="p-6 text-center">
                  <div className="w-32 h-32 rounded-full bg-gradient-to-br from-primary/20 to-primary/5 flex items-center justify-center mb-4 mx-auto overflow-hidden">
                    <img src={nnennaImage} alt="Nnenna Nnadili" className="w-full h-full object-cover" />
                  </div>
                  <h5 className="text-lg font-bold mb-1">Nnenna Nnadili</h5>
                  <p className="text-sm font-semibold text-primary mb-2">Chairperson of the Board</p>
              ...
              <Card className="border-border/50 bg-card/50 backdrop-blur-sm hover:border-primary/50 transition-all duration-300">
                <CardContent className="p-6 text-center">
                  ...
                  <h5 className="text-lg font-bold mb-1">Dr. John Ibebunjo</h5>
                  <p className="text-sm font-semibold text-primary mb-2">Strategic Planning & Research Consultant</p>
                  <p className="text-xs text-muted-foreground leading-relaxed">
              ...
              <Card className="border-border/50 bg-card/50 backdrop-blur-sm hover:border-primary/50 transition-all duration-300">
                <CardContent className="p-6 text-center">
                  ...
                  <h5 className="text-lg font-bold mb-1">Dr. Okiti Ogho</h5>
                  <p className="text-sm font-semibold text-primary mb-2">Policy, Ideas & Capital Economic Transformer</p>
                  <p className="text-xs text-muted-foreground leading-relaxed">
          ...
          <div>
            ...
            <div className="mb-8">
              ...
              <div className="grid md:grid-cols-3 gap-4 max-w-4xl mx-auto">
                <Card className="border-border/50 bg-card/50 backdrop-blur-sm hover:border-primary/50 transition-all duration-300">
                  <CardContent className="p-6 text-center">
                    <div className="w-24 h-24 rounded-full bg-gradient-to-br from-primary/20 to-primary/5 flex items-center justify-center mb-3 mx-auto overflow-hidden">
                      <img src={chineduImage} alt="Chinedu Emmanuel Oleka" className="w-full h-full object-cover" />
                    </div>
                    <p className="font-semibold text-sm">Chinedu Emmanuel Oleka</p>
                ...
                <Card className="border-border/50 bg-card/50 backdrop-blur-sm hover:border-primary/50 transition-all duration-300">
                  <CardContent className="p-6 text-center">
                    <div className="w-24 h-24 rounded-full bg-gradient-to-br from-primary/20 to-primary/5 flex items-center justify-center mb-3 mx-auto overflow-hidden">
                      <img src={favorImage} alt="Favor Enoch" className="w-full h-full object-cover" />
                    </div>
                    <p className="font-semibold text-sm">Favor Enoch</p>
                    <p className="text-xs text-muted-foreground">Administrator & Finance Officer</p>
                  </CardContent>
                </Card>
                <Card className="border-border/50 bg-card/50 backdrop-blur-sm hover:border-primary/50 transition-all duration-300">
                  <CardContent className="p-6 text-center">
                    ...
                    <p className="font-semibold text-sm">Esther Okpala</p>
                    <p className="text-xs text-muted-foreground">Technical Operations Officer</p>
                  </CardContent>
                </Card>
              </div>
            </div>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 max-w-5xl mx-auto">
                <Card className="border-border/50 bg-card/50 backdrop-blur-sm hover:border-primary/50 transition-all duration-300">
                  <CardContent className="p-4 text-center">
                    <div className="w-20 h-20 rounded-full bg-gradient-to-br from-primary/20 to-primary/5 flex items-center justify-center mb-3 mx-auto overflow-hidden">
                      <img src={ekeImage} alt="Inyang Akanimo Sunday" className="w-full h-full object-cover" />
                    </div>
                    <p className="font-semibold text-sm">Inyang Akanimo Sunday</p>
                    <p className="text-xs text-muted-foreground">Project & Product Manager</p>
                  </CardContent>
                </Card>
                <Card className="border-border/50 bg-card/50 backdrop-blur-sm hover:border-primary/50 transition-all duration-300">
                  <CardContent className="p-4 text-center">
                    ...
                    <p className="font-semibold text-sm">Ifeanyi Nneji</p>
                    <p className="text-xs text-muted-foreground">AI & Full Stack Manager</p>
                  </CardContent>
                </Card>
                <Card className="border-border/50 bg-card/50 backdrop-blur-sm hover:border-primary/50 transition-all duration-300">
                  <CardContent className="p-4 text-center">
                    <div className="w-20 h-20 rounded-full bg-gradient-to-br from-primary/20 to-primary/5 flex items-center justify-center mb-3 mx-auto overflow-hidden">
                      <img src={toluImage} alt="Toluwanimi Ayoola" className="w-full h-full object-cover object-top" />
                    </div>
                    <p className="font-semibold text-sm">Toluwanimi Ayoola</p>
                ...
                <Card className="border-border/50 bg-card/50 backdrop-blur-sm hover:border-primary/50 transition-all duration-300">
                  <CardContent className="p-4 text-center">
                    ...
                    <p className="font-semibold text-sm">Ivie Valentine</p>
                ...
                <Card className="border-border/50 bg-card/50 backdrop-blur-sm hover:border-primary/50 transition-all duration-300">
                  <CardContent className="p-4 text-center">
                    ...
                    <p className="font-semibold text-sm">Ogunkuade Ayobamidele</p>
                    <p className="text-xs text-muted-foreground">Frontend Engineer</p>
                  </CardContent>
                </Card>
                <Card className="border-border/50 bg-card/50 backdrop-blur-sm hover:border-primary/50 transition-all duration-300">
                  <CardContent className="p-4 text-center">
                    ...
                    <p className="font-semibold text-sm">Awesome Bassey</p>
                    <p className="text-xs text-muted-foreground">DevOps Manager</p>
                  </CardContent>
                </Card>
              </div>
            </div>
              ...
              <div className="grid md:grid-cols-3 gap-4 max-w-4xl mx-auto">
                <Card className="border-border/50 bg-card/50 backdrop-blur-sm hover:border-primary/50 transition-all duration-300">
                  <CardContent className="p-4 text-center">
                    ...
                    <p className="font-semibold text-sm">Victor Jimmy</p>
                    <p className="text-xs text-muted-foreground">Product & Brand Design Manager</p>
                  </CardContent>
                </Card>
                <Card className="border-border/50 bg-card/50 backdrop-blur-sm hover:border-primary/50 transition-all duration-300">
                  <CardContent className="p-4 text-center">
                    ...
                    <p className="font-semibold text-sm">Onyinyechi Sopuruchi-Obiagbaso</p>
                    <p className="text-xs text-muted-foreground">Product & Brand Designer</p>
                  </CardContent>
                </Card>
                <Card className="border-border/50 bg-card/50 backdrop-blur-sm hover:border-primary/50 transition-all duration-300">
                  <CardContent className="p-4 text-center">
                    ...
                    <p className="font-semibold text-sm">Micheal Obazu</p>
                    <p className="text-xs text-muted-foreground">Product & Brand Designer</p>
                  </CardContent>
                </Card>
              </div>
              ...
              <div className="grid md:grid-cols-3 gap-4 max-w-4xl mx-auto">
                <Card className="border-border/50 bg-card/50 backdrop-blur-sm hover:border-primary/50 transition-all duration-300">
                  <CardContent className="p-4 text-center">
                    ...
                    <p className="font-semibold text-sm">Kingsley Chukwuma</p>
                    <p className="text-xs text-muted-foreground">Social Media & Digital Marketing Manager</p>
                  </CardContent>
                </Card>
                <Card className="border-border/50 bg-card/50 backdrop-blur-sm hover:border-primary/50 transition-all duration-300">
                  <CardContent className="p-4 text-center">
                    ...
                    <p className="font-semibold text-sm">Lee Frank</p>
                ...
                <Card className="border-border/50 bg-card/50 backdrop-blur-sm hover:border-primary/50 transition-all duration-300">
                  <CardContent className="p-4 text-center">
                    ...
                    <p className="font-semibold text-sm">Obinna Nzem</p>
