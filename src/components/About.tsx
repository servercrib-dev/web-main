        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-4xl mx-auto mb-4 leading-relaxed animate-fade-in">
              Servercrib Technology Solutions is a U.S. and African-based global
              IT firm dedicated to empowering organizations through secure,
              scalable, and intelligent innovation.
            </p>
            <p className="text-lg md:text-xl text-muted-foreground max-w-4xl mx-auto mb-4 leading-relaxed animate-fade-in">
              We combine cutting-edge AI, Cloud, ERP, and Security technologies
              to help enterprises optimize performance, automate workflows, and
              drive growth.
            </p>
            <p className="text-lg md:text-xl text-muted-foreground max-w-4xl mx-auto mb-8 leading-relaxed animate-fade-in">
              Servercrib is the cradle of intelligent innovation — the
              birthplace of ecosystems that serve humanity.
            </p>
            ...
            <div className="mt-12 p-8 bg-card/50 backdrop-blur-sm border border-border/50 rounded-lg max-w-3xl mx-auto animate-fade-in">
              <p className="text-lg text-muted-foreground leading-relaxed mb-4">
                ...
                : a network that builds worlds through automation and
                intelligence.
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed mb-4">
                Then comes{" "}
                <span className="text-foreground font-semibold">Defendria</span>
                , the guardian of those worlds, ensuring every system remains
                trusted, compliant, and secure.
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed mb-4">
                And finally,{" "}
                <span className="text-foreground font-semibold">
                  Servercrib Consulting & Academy
                </span>{" "}
                steps in to bring these systems to life in the hands of real
                people — implementing, integrating, and educating the next
              ...
              <p className="text-base text-muted-foreground leading-relaxed italic">
                This triad is more than a brand family — it's a movement toward
                intelligent digital sovereignty.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="text-center max-w-4xl mx-auto mb-16">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed mb-6">
              <span className="text-foreground font-semibold">AVEN</span> stands
              for{" "}
              <span className="text-foreground font-semibold">
                Automated Virtual Environment Network
              </span>{" "}
              — a self-learning system that automates the creation of digital
              environments, turning ideas into intelligent software.
            </p>
              ...
              <Card className="border-border/50 bg-card/50 backdrop-blur-sm">
                <CardContent className="p-4">
                  ...
                  <p className="text-xs text-muted-foreground">
                    AI-powered creation and workflow generation
                  </p>
                </CardContent>
              </Card>
              <Card className="border-border/50 bg-card/50 backdrop-blur-sm">
                <CardContent className="p-4">
                  ...
                  <p className="text-xs text-muted-foreground">
                    The digital universe where innovation lives
                  </p>
                </CardContent>
              </Card>
              <Card className="border-border/50 bg-card/50 backdrop-blur-sm">
                <CardContent className="p-4">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Intelligent ecosystems for work, learning, and growth
                  </p>
                </CardContent>
              </Card>
              <Card className="border-border/50 bg-card/50 backdrop-blur-sm">
                <CardContent className="p-4">
                  ...
                  <p className="text-xs text-muted-foreground">
                    The connected structure linking users, apps, and data
                  </p>
                </CardContent>
              </Card>
            </div>
            ...
            <p className="text-base text-muted-foreground leading-relaxed mb-4">
              Rooted in meanings like "avenue" (pathway) and "avènement"
              (arrival), AVEN symbolizes the flow of intelligent creation and
              the dawn of a new digital era.
            </p>
            <p className="text-xl text-foreground font-bold">
              AVEN builds the world. Defendria secures it. Servercrib implements
              and trains it.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-20">
            <Card className="border-border/50 bg-card/50 backdrop-blur-sm">
              <CardContent className="p-8">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  To become a global leader in secure digital transformation,
                  empowering enterprises and communities worldwide through
            ...
            <Card className="border-border/50 bg-card/50 backdrop-blur-sm">
              <CardContent className="p-8">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  To deliver secure, intelligent, and innovative platforms that
                  simplify operations, protect digital assets, and accelerate
                  business growth through excellence, integrity, and
