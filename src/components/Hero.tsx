      ...
      <div className="container mx-auto px-4 relative z-10 text-center py-20">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-4xl mx-auto leading-relaxed animate-fade-in">
            At Servercrib Technology Solutions, we help organizations innovate
            with confidence — combining the best of AI, Cloud, ERP, CRM,
            Cybersecurity, and Data Intelligence into one connected ecosystem.
          </p>
          ...
          {/* Scroll Indicator */}
          <div className="flex justify-center animate-bounce cursor-pointer" onClick={scrollToStats}>
